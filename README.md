...
2. **하네스 설치** — Django/JS 템플릿 기반으로 `.claude/`, `.github/`, `.gemini/` 구성
...
5. **DOMAIN.md 자동 채우기** — `domain-fill.sh`가 Claude Code로 각 앱의 `models.py`를 분석해 실제 내용을 채운 뒤, 루트 `DOMAIN.md`까지 통합 합성
