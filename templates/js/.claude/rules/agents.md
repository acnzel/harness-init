...
JS/TS 프로젝트 전용 5인 에이전트 팀. 기능 개발 및 유지보수 작업 시 호출한다.
...
| 팀원 | 파일 | 역할 |
|------|------|------|
| analyst | `.claude/agents/analyst.md` | 영향 범위 식별, 스키마/타입 선행 분석 |
| architect | `.claude/agents/architect.md` | Controllers/Services/Repositories 설계, 테스트 전략 |
...
- "하네스 팀 실행", "프론트엔드 팀으로 처리" 등 명시적 호출
...
| `_workspace/01_ticket_analysis.md` | analyst | 영향 범위·타입 분석·제약사항 |
